...
for indicator in indicators:
    ...
    ind_data = ind_data.reindex(all_dates).interpolate().ffill()
...
for forecast_feature in forecast_features:
    for feature in combined_df.columns:
        ...
        if feature[0] == 'stock' and feature[2] == 'Adj Close' and feature != forecast_feature:
            optimal_lags = calculate_optimal_lags(combined_df, forecast_feature, feature)
...
# Drop any rows with NaN values generated by shifting
combined_df.dropna(inplace=True)

# Ensure the final DataFrame is properly sorted
